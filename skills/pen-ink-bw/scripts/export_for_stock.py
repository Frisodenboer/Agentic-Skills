#!/usr/bin/env python3
"""
Copy a finished Pen-Ink-BW artwork (unsigned -- this skill does not sign
its output) into a dated export directory and append an Adobe Stock
bulk-upload metadata row for it. Works for any subject matter.

Usage:
  python export_for_stock.py \
    --image "public/Artwork/nool-pen-ink-bw-barn-owl.jpg" \
    --title "Hand-Drawn Black and White Pen and Ink Barn Owl in Flight Illustration" \
    --keywords "pen and ink,illustration,black and white,monochrome,barn owl,bird,wildlife,cross hatch,engraving,hand drawn,sketch,line art,wall art,ink drawing,nature illustration" \
    --category 1
...
def main():
    ...
    parser.add_argument("--image", required=True, help="Path to the finished artwork file")
